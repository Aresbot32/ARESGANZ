...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Aresbot32/ARESGANZ)
...
git clone https://github.com/Aresbot32/ARESGANZ
cd wabot-aq
npm install
npm update
```
